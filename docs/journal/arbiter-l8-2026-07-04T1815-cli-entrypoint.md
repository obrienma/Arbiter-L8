---
id: arbiter-l8-2026-07-04T1815-cli-entrypoint
repo: arbiter-l8
...
files: [src/arbiter_l8/cli.py, pyproject.toml, tests/test_cli.py, README.md]
---

### Pattern: The CLI Wraps the Offline Harness Only, Not the Online Layers

`arbiter-l8` (`[project.scripts]` -> `arbiter_l8.cli:main`) wires a
