---
id: sentinel-eval-2026-07-06T1853-synapse-l4-ground-truth-fixture
repo: sentinel-eval
...
The contradiction trap is Synapse-L4's own code, not sentinel-eval's —
...
was fixed here (sentinel-eval's own code) while Sentinel-L7's semantic
