---
id: arbiter-l8-2026-07-04T0328-config-module-foundation
repo: arbiter-l8
...
files: [pyproject.toml, src/arbiter_l8/config.py, tests/test_config.py]
---

First step of wiring arbiter-l8 up to real services (Synapse-L4,
Sentinel-L7, a remote judge) instead of only fixture data. Added `httpx`
and `respx` (dev), and `src/arbiter_l8/config.py` — env-var-with-default
...
Rather than inventing arbiter-l8-specific env var names for Gemini
