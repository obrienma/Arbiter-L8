---
id: arbiter-l8-2026-07-06T0245-synapse-l4-live-verification
repo: arbiter-l8
...
files: [src/arbiter_l8/adapters/synapse_l4.py]
---

Closes the gap flagged in the Synapse-L4 adapter entry
(`arbiter-l8-2026-07-04T0435-synapse-l4-adapter.md`, "Challenge: No live
...
`arbiter-l8` console script wrapping it. Re-ran the fast-path and
judge-rejection cases a second time through the actual
`uv run arbiter-l8 --system synapse-l4 ...` CLI (one-off fixtures under
