---
id: sentinel-eval-2026-07-04T1512-judge-layer
repo: sentinel-eval
...
files: [src/sentinel_eval/online/judge.py, prompts/judge.md, prompts/judge.txt, tests/test_judge.py, README.md]
---
...
sentinel-eval, following the user's standing directive (mirrored from
