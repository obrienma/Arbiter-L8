---
id: sentinel-eval-2026-07-03T1916-otel-instrumentation
repo: sentinel-eval
...
files: [pyproject.toml, src/sentinel_eval/observability/_env.py, src/sentinel_eval/observability/tracing.py, src/sentinel_eval/observability/metrics.py, src/sentinel_eval/observability/decorators.py, src/sentinel_eval/observability/__init__.py, src/sentinel_eval/online/heuristics.py, src/sentinel_eval/online/disagreement.py, src/sentinel_eval/online/consistency.py, src/sentinel_eval/online/judge.py, src/sentinel_eval/online/pipeline.py, src/sentinel_eval/harness.py, tests/test_observability.py, tests/test_judge.py, tests/test_pipeline.py, README.md]
cross_ref: observability
cross_ref_id: sentinel-eval-2026-07-03T1916-otel-instrumentation
---
...
wiring sentinel-eval's tracer the same way. Root cause: Synapse-L4's
...
("must come before any instrumented module is imported"). sentinel-eval's
