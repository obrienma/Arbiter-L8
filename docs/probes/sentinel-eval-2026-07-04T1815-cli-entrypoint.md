...
tags: [sentinel-eval, cli, scope]
---
Q: Why does `sentinel-eval`'s CLI only wrap the offline harness
...
Extra: sentinel-eval · Pattern: The CLI Wraps the Offline Harness Only, Not the Online Layers
See: docs/journal/sentinel-eval-2026-07-04T1815-cli-entrypoint.md

---
type: cloze
deck: Rhizome::sentinel-eval
tags: [sentinel-eval, cli, taxonomy]
---
...
Extra: sentinel-eval · Pattern: A Post-Hoc Wrapper for --binary, Not a Harness-Level Flag
See: docs/journal/sentinel-eval-2026-07-04T1815-cli-entrypoint.md

---
type: basic
deck: Rhizome::sentinel-eval
tags: [sentinel-eval, live-verification, timeout]
---
...
Extra: sentinel-eval · Challenge: Live Ollama Driver-Override Latency Is Close to the Adapter's Default Timeout
See: docs/journal/sentinel-eval-2026-07-04T1815-cli-entrypoint.md

---
type: basic
deck: Rhizome::sentinel-eval
tags: [sentinel-eval, cli, fixture-defect]
---
...
Extra: sentinel-eval · Decision: Require --fixture Explicitly, No Per-System Default Path
See: docs/journal/sentinel-eval-2026-07-04T1815-cli-entrypoint.md
