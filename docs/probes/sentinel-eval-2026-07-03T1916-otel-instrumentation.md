...
tags: [sentinel-eval, context-decorator]
---
...
Extra: sentinel-eval · Pattern: Context Manager as Decorator
See: docs/journal/sentinel-eval-2026-07-03T1916-otel-instrumentation.md
...
type: cloze
deck: Rhizome::sentinel-eval
tags: [sentinel-eval, root-span-fragmentation]
---
...
Extra: sentinel-eval · Anti-Pattern Avoided: Deferred SDK Initialization
See: docs/journal/sentinel-eval-2026-07-03T1916-otel-instrumentation.md

---
type: basic
deck: Rhizome::sentinel-eval
tags: [sentinel-eval, additive-observability]
---
...
timeout either, so leaving the SDK default in place keeps sentinel-eval
consistent with the rest of the suite rather than diverging on a
unilateral judgment call.

Extra: sentinel-eval · Challenge: OTLP Retry Backoff in Tests
See: docs/journal/sentinel-eval-2026-07-03T1916-otel-instrumentation.md
...
Extra: sentinel-eval · Pattern: Circuit Breaker (traced)
See: docs/journal/sentinel-eval-2026-07-03T1916-otel-instrumentation.md
