---
id: sentinel-eval-2026-07-04T0435-synapse-l4-adapter
repo: sentinel-eval
title: "First Real System-Under-Test: the Synapse-L4 HTTP Adapter"
date: 2026-07-04
phase: 3
tags: [adapter-pattern, respx, additive-observability]
files: [src/sentinel_eval/adapters/__init__.py, src/sentinel_eval/adapters/synapse_l4.py, tests/test_synapse_l4_adapter.py, README.md]
---
...
runs on Python 3.14 against sentinel-eval's pinned 3.12, and importing its
