...
Extra: sentinel-eval · Pattern: Adapter, reused and made concrete
See: docs/journal/sentinel-eval-2026-07-04T0435-synapse-l4-adapter.md
...
service-specific; it runs on Python 3.14 against sentinel-eval's pinned
...
Extra: sentinel-eval · Decision: HTTP over direct import
See: docs/journal/sentinel-eval-2026-07-04T0435-synapse-l4-adapter.md
...
Extra: sentinel-eval · Challenge: No live verification this step
See: docs/journal/sentinel-eval-2026-07-04T0435-synapse-l4-adapter.md
